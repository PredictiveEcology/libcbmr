...
spinup <- function(spinup_input) {
  ...
  ## assign the config path here for the cbm_exn_model$initialize method. That
  ## will set a path from where all of the parameters will be read from, and if
  ## it's not specified it will pull these parameters from
  ...
  ##TODO why is csv not 2X the cbmData?
  
  ## disturbance_matrix_value.csv (14793X4) - this is a match
  ## outDefaults$cbmData@disturbanceMatrixValues (21339X4) ecept that insteads
  ## of "ids" (source_pool_id sink_pool_id), the source_pool and sin_pool are
  ...
  ## python module and into the c++ functions in spadesCBM
  ...
  ## instead of repeating the same line for all SPUs, and has the
